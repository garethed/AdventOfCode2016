...
namespace AdventOfCode2016
{
    class Day7
    {
        public static string Part1()
        {
            ...
            return Utils.splitLines(input).Count(l => supportsTLS(l)).ToString();
            
        }

        public static string Part2()
        {
            foreach (var part in "abba[mnop]qrst".Split('[', ']').Where((v, i) => i % 2 == 0))
            {
            ...
            return Utils.splitLines(input).Count(l => supportsSSL(l)).ToString();

        }

        public static void test(string ip)
        {
            Console.WriteLine(ip + ": " + supportsTLS(ip));
        }

        public static void test2(string ip)
        {
            Console.WriteLine(ip + ": " + supportsSSL(ip));
        }
        ...
        public static bool supportsSSL(string ip)
        {
            ...
            for (int i = 2; i < ip.Length; i++)
            {
                    ...
                    && char.IsLetter(ip[i - 1]))
                {
                    if (inHS)
                    {
                        BABs.Add(ip.Substring(i - 2, 3));
                    }
                    else
                    {
                        ABAs.Add(ip.Substring(i - 1, 2) + ip[i - 1]);
                    }
                }
            ...
            return BABs.Any(b => ABAs.Contains(b));
        }
